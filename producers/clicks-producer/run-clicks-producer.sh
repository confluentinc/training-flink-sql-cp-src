...
SOURCE="$SCRIPT_DIR/ClicksProducer.java"
...
echo "Starting clicks producer (delay=${DELAY_MS}ms, bootstrap=${BOOTSTRAP_SERVERS})..."
java -Dlog4j.configuration="file:$LOG4J_CFG" -cp "$CLASS_DIR:$CLASSPATH" ClicksProducer 2> >(grep -v "^SLF4J:" >&2)
